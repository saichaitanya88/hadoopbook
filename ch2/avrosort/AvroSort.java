...
//    }
    ...
    String input = "/home/cloudera/hd/data/pairs.avro";//args[0];
    String output = "/home/cloudera/hd/data/output";//args[1];
    String schemaFile = "/home/cloudera/hd/data/resources/SortedStringPair.avsc";//args[2];
